...
* Maven 3.6.3
* Docker (optional)
* [core-geonetwork:4.2.13](https://github.com/geonetwork/core-geonetwork/releases/tag/4.2.13), might need a local build, it's not available on any published maven repository?
